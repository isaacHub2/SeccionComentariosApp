...
import com.isaac.comentariosestaticos.app.ComentariosApp;

public class SolicitadorImagen {
    private static SolicitadorImagen instance = null;
    private final Context context;
    private final RequestQueue requestQueue;
    private final ImageLoader imageLoader;
    private final int maxByteSize;

    private SolicitadorImagen(){
        context = ComentariosApp.getAppContext();
    ...
    public static SolicitadorImagen getInstance(){
        if (instance == null){
            instance = new SolicitadorImagen();
        }
        return instance;
    }
